  ...
  return (
    <div className="">
      <TwoColumns
        left={
          <>
            <Header type="h2">Vertrauen beginnt mit Klarheit</Header>
          </>
        }
        right={
          <>
        ...
        left={
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                Je nach Anliegen erfolgt eine umfassende Anamnese, ggf. eine körperliche Untersuchung sowie die Planung
                weiterer diagnostischer Schritte (z.B. Labor, hormonelle Diagnostik, Schilddrüsenultraschall).
              </TextContent>
            ...
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                ...
                Unterstützung. Mir ist wichtig, transparent zu arbeiten und den Behandlungsverlauf regelmäßig gemeinsam
            ...
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                ...
                hochwirksamer Blutverdünnung oder schweren Tumorerkrankungen. Dies kläre ich immer sorgfältig im Rahmen
                der Anamnese ab.
              </TextContent>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                ...
                Zusammenhänge zu verstehen, Regulationsprozesse zu fördern und nachhaltige Veränderungen zu ermöglichen.
              </TextContent>
            </div>
            <div className="flex flex-col gap-4">
              <Header type="b">Wie lange dauert eine Sitzung?</Header>
              <TextContent>
                Die Dauer richtet sich nach Art des Termins. Der Ersttermin nimmt in der Regel mehr Zeit in Anspruch als
                Folgetermine. Genaue Zeitrahmen teile ich Ihnen vor der Terminvereinbarung transparent mit.
              </TextContent>
            </div>
          </div>
        }
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                ...
                ausfüllen können. Dieser hilft Ihnen, Ihre Beschwerden und Fragen zu sortieren, und ermöglicht mir, mir
            ...
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                Heilpraktikerleistungen werden in der Regel nicht von den gesetzlichen Krankenkassen übernommen. Private
                Krankenversicherungen oder Zusatzversicherungen erstatten die Kosten je nach Tarif ganz oder teilweise.
                Bitte informieren Sie sich hierzu vorab bei Ihrer Versicherung.
              </TextContent>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <TextContent>
                ...
                Betrachtung sinnvoll. Voraussetzung ist, dass ernsthafte organische Ursachen ärztlich abgeklärt wurden.
              </TextContent>
            </div>
            <div className="flex flex-col gap-4">
